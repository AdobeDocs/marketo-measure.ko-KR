...
CallTrackingMetrics는 이 기능이 작동하려면 개발 작업을 수행해야 합니다. CallTrackingMetrics는 사이트에 배치한 JavaScript을 사용하여 [!DNL Marketo Measure] 쿠키에서 `_biz_uid`을(를) 가져올 수 있습니다. 그러면 CallTrackingMetrics에 의해 이 &quot;BizibleId&quot;가 저장됩니다.
