---
description: Marketo Measure 사용자를 위한 호출 추적 통합 지침
title: 호출 추적 통합
...
일반적인 의미의 ![&quot;통화 추적&quot;은(는) 다음과 같은 회사의 제품입니다.](assets/other-resources-6.png)
...
![통합을 통해 웹 세션이 실제로 있었음을 확인할 수 있습니다.](assets/other-resources-4.png)

## 작동 방법 {#how-it-works}

CallTrackingMetrics는 이 기능이 작동하려면 개발 작업을 수행해야 합니다. CallTrackingMetrics는 사이트에 배치한 JavaScript을 사용하여 `_biz_uid` 쿠키에서 [!DNL Marketo Measure]을(를) 가져올 수 있습니다. 그러면 CallTrackingMetrics에 의해 이 &quot;BizibleId&quot;가 저장됩니다.
...
![다음은 BizibleId가 있는 작업 레코드의 예입니다](assets/other-resources-5.png)
...
Marketo Measure에서 일반적으로 푸시하는 ![접점 유형 값은 웹 방문](assets/other-resources-1.png)입니다.
