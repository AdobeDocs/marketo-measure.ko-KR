  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>키워드 및 Creative ROI 요약:</strong>사용되지 않음(아래 참조)</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            <strong>집단 Funnel:</strong>집단 여정 대시보드</li>
          <li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>키워드 및 Creative ROI 요약</strong>
        </p>
      </td>
      <td>
...
* **날짜 유형, 지표, Dimension, 그룹화 기준**: 이제 insight 게재를 최적화하기 위해 각 대시보드에 대해 이러한 설정이 미리 정의되어 있습니다. 자세한 내용은 도구 설명 및 관련 설명서를 통해 확인할 수 있습니다.
* **캠페인 소스**
* **계정 ID 및 이름**: 검토 중입니다.

## 새로운 추가 및 개선 사항 {#new-additions-and-improvements}

새로운 기능은 [대시보드 기본 사항 살펴보기](/help/discover-dashboard-basics.md){target="_blank"} 문서에서 확인할 수 있습니다.
...
>[!MORELIKETHIS]
>
>* [대시보드 기본 사항 살펴보기](/help/discover-dashboard-basics.md){target="_blank"}
>* [대시보드 데이터 가시성 정책](/help/dashboard-data-visibility-policy.md){target="_blank"}
