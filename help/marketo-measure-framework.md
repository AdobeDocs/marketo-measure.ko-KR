---
description: Marketo Measure 프레임워크
...
>[!NOTE]
>Marketo Measure JS를 추가하는 방법에 대한 지침을 보려면 [여기를 클릭](/help/marketo-measure-tracking/adding-marketo-measure-script.md)하십시오.
...
![Marketo Measure은 CRM과 통합되어 모든 데이터를 관리하고 구성합니다](assets/overview-resources-14.png)

CRM에 Marketo Measure 데이터를 표시하면 각 터치포인트와 관련된 세부적인 정보를 보고 채널의 실적을 파악하는 보고서를 생성할 수 있습니다.

## 서드파티 애플리케이션 {#third-party-applications}

대부분의 마케터는 마케팅 활동을 실행하기 위해 몇 가지 다른 애플리케이션에 의존합니다. Salesforce 및 MS Dynamics 외에도 Marketo Measure은 13개의 타사 응용 프로그램(아래에 나열됨)과 통합됩니다.

![대부분의 마케터는 몇 가지 다른 응용 프로그램을 사용하여 마케팅을 실행합니다](assets/overview-resources-15.png)
