---
description: 판독기 계정을 설정하고 사용하여 Marketo Measure Data Warehouse에 액세스하는 방법에 대해 설명합니다
...
1. 왼쪽 메뉴에서 보안 아래의 **[!UICONTROL Data Warehouse]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 왼쪽 메뉴에서 보안 아래의 Data Warehouse을 클릭합니다.](assets/data-account-8.png)
...
1. Snowflake URL에 제공된 링크를 클릭하면 사용자 이름과 암호를 입력하는 Snowflake 로그인 페이지로 이동합니다. _암호가 없으면 아래 단계를 참조하여 암호를 재설정하십시오._.
...
* **웨어하우스 이름**(항상 필요한 것은 아님)
  ...
  ![웨어하우스는 Snowflake에서 쿼리를 실행합니다. 계산됨](assets/data-account-2.png)
