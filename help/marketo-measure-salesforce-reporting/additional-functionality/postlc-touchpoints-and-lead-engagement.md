...
![Salesforce에서 PostLC 터치포인트를 보여 주는 리드 레코드](assets/1.png)
...
![PostLC 터치포인트 목록이 가장 최근 제출 항목 4개로 제한됨](assets/2.png)
...
1. [!DNL Marketo Measure]experience.adobe.com/marketo-measure[에서 &#x200B;](https://experience.adobe.com/marketo-measure){target="_blank"} 계정에 로그인하고 [!UICONTROL Settings]&#x200B;(으)로 이동합니다.

1. CRM에서 **[!UICONTROL Leads]**&#x200B;을(를) 선택합니다.

1. 리드에 푸시할 postLC 터치포인트 수를 입력하고 **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.

   ![PostLC 터치포인트 제한을 설정하는 리드 설정 페이지](assets/3.png)
...
1. 연락처에 푸시할 postLC 터치포인트의 수를 입력하고 **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
   ...
   ![PostLC 터치포인트 제한을 설정하는 연락처 설정 페이지](assets/4.png)
