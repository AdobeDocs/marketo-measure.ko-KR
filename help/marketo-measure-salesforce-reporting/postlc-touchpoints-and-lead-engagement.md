---
description: PostLC 터치포인트를 만드는 방법을 리드 및 연락처에 대해 업데이트하고 제한합니다.
...
![PostLC(Marketo Measure Post-Lead Creation) 터치포인트를 사용하는 고객에게 사용 가능](assets/additional-functionality-1.png)
