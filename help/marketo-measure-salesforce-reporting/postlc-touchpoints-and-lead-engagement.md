...
1. [experience.adobe.com/marketo-measure](https://experience.adobe.com/marketo-measure){target="_blank"}에서 [!DNL Marketo Measure] 계정에 로그인하고 [!UICONTROL Settings]&#x200B;(으)로 이동합니다.
