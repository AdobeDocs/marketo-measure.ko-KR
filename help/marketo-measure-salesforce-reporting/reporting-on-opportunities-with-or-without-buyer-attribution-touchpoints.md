---
description: Marketo Measure 사용자를 위한 구매자 속성 터치포인트가 있거나 없는 기회 보고
...
1. **[!UICONTROL Setup]** > **[!UICONTROL Create]** > **[!UICONTROL Report Types]**(으)로 이동합니다.
   ...
   ![1. 보고서 유형 설정으로 이동하십시오.](assets/bizible-guide-1.png)

1. **[!UICONTROL New Custom Report Type]**&#x200B;를 선택합니다.

   ![1. 새 사용자 지정 보고서 유형을 선택하십시오.](assets/bizible-guide-2.png)
...
1. 거기에서 기회 객체를 구매자 속성 터치포인트 객체에 연결합니다. &quot;&#39;A&#39; 레코드 관련 &#39;B&#39; 레코드가 있을 수도 있고 없을 수도 있습니다.&quot; 버튼을 선택해야 합니다. 완료되면 **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 여기에서 Opportunities 개체를 구매자](assets/bizible-guide-4.png)에 연결합니다.
