...
>[!NOTE]
>
>BAT는 BT에서 만들어집니다. 본질적으로, 추적은 BT들을 통해 개별 레벨에서 시작된다. 계정에서 Opportunity 가 생성되면 동일한 계정 아래에 있는 연락처의 모든 BT 가 참조되어 Opportunity 와 관련된 BAT 를 생성할 수 있으므로 답하려는 질문에 따라 Opportunity 와 관련된 질문 (BT 보고서 ) 또는 Opportunity 지표 와 관련된 질문 (BAT 보고서 ) 을 하나씩 사용합니다
