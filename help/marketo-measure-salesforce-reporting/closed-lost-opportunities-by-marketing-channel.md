---
description: Marketo Measure 사용자에 대한 마케팅 채널 지침으로 영업 기회 유실을 마감했습니다.
...
1. Salesforce에서 **[!UICONTROL Reports]** 탭을 클릭하고 **[!UICONTROL New Report]**&#x200B;을(를) 선택합니다.
   ...
   ![1. Salesforce에서 보고서 탭을 클릭하고 새로 만들기](assets/bizible-guide-1.png)를 선택합니다.
...
1. 보고서 맨 위부터 &quot;[!UICONTROL All Bizible Attribution Touchpoints]&quot;을(를) 표시하고 보고할 일정에 따라 날짜 필드를 조정합니다. 이 예제에서는 All Time을 살펴보겠습니다. 또한 보고서 형식을 테이블 형식에서 요약으로 변경합니다.
   ...
   ![1. 보고서 맨 위부터 &quot;모든 Bizible](assets/marketo-reports-8.jpg) 표시

   ![1. 보고서 맨 위부터 &quot;모든 Bizible](assets/bizible-guide-3.png) 표시
