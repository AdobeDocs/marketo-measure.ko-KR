---
description: 테이블 및 열을 자세히 설명하는 Marketo Measure 데이터 웨어하우스 스키마 참조
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   <td><a href="assets/data-warehouse-data-model.pdf">&lt;img alt="데이터 썸네일 1" src="assets/data-thumb-1.png"</a></td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>timestamp_ntz</td>
      <td>Snowflake에서 레코드를 마지막으로 수정한 날짜.</td>
      <td>2020-01-01 01:01:00.000</td>
    </tr>
    <tr>
      <td>_DELETED_DATE</td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Buyer Attribution Touchpoint(BAT)에 대한 고유 ID.</p>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>터치포인트의 원인이 되는 소스를 정의하는 데 사용됩니다. 이 값은 utm_source의 URL에서 구문 분석할 수 있으며, CRM에서 동기화된 경우 일반적으로 "CRM Campaign"으로 설정되거나 [!DNL Marketo Measure]에서 광고를 확인할 수 있는 경우 "Google AdWords" 또는 "Facebook"과 같은 값일 수 있습니다. CRM에서 "터치포인트 Source"라고 합니다.</p>
      </td>
      <td>
        <p>linkedin</p>
      </td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>광고가 해결된 광고 계정의 Creative ID입니다. 이는 Google AdWords 및 Bing Ads(검색)에 적용됩니다.</p>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>광고가 해결된 광고 계정의 Creative 이름입니다. 이는 Google AdWords 및 Bing Ads(검색)에 적용됩니다.</p>
      </td>
      <td>
        <p>B2B 마케팅 속성</p>
      </td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>검색 광고에서 가져온 Creative의 첫 번째 줄이며, 광고가 해결된 광고 계정에서 가져옵니다. 이는 Google AdWords 및 Bing Ads(검색)에 적용됩니다.</p>
      </td>
      <td>
        <p>CMO 안내서 다운로드</p>
      </td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>검색 광고에서 가져온 Creative의 두 번째 줄이며, 광고가 해결된 광고 계정에서 가져옵니다. 이는 Google AdWords 및 Bing Ads(검색)에 적용됩니다.</p>
      </td>
      <td>
...
기여도 AI 통합에서 생성된 데이터. 이러한 필드는 Marketo Measure Ultimate 고객에게만 채워집니다.
...
<table>
  <tbody>
    ...
    <tr>
      <td>_DELETED_DATE</td>
      <td>timestamp_ntz</td>
      <td>Snowflake에서 레코드가 삭제된 것으로 표시된 날짜입니다.</td>
      <td>2020-01-01 01:01:00.000</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>광고 연결에서 가져온 Creative의 이름입니다.</p>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <p>행에 Creative으로 합산될 수 있는 비용이 포함되어 있는지 여부를 나타냅니다. (예: Creative 비용을 가져오려면 이 열이 true인 행의 합계를 구하십시오.)</p>
      </td>
      <td>
        <p>거짓</p>
      </td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Creative을 가져온 광고 계정의 ID입니다.</p>
      </td>
      <td>fb.106851586409075</td>
    </tr>
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Creative을 가져온 광고 계정의 이름입니다.</p>
      </td>
      <td>
        <p>[!DNL Marketo Measure]</p>
      </td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Creative, 특히 Doubleclick에 대한 광고주 ID.</p>
      </td>
      <td>
        <p>300181641</p>
      </td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Creative(특히 Doubleclick)에 대한 광고주 이름입니다.</p>
      </td>
      <td>
        <p>[!DNL Marketo Measure] Marketing Analytics</p>
      </td>
    ...
    <tr>
      ...
      <td>
        <p>소스 시스템에서 Creative이 여전히 활성 상태인지 여부입니다.</p>
      </td>
      <td>
        <p>참</p>
      </td>
    ...
    <tr>
      ...
      <td>
        <p>소스 시스템에서 Creative이 삭제되었는지 여부.</p>
      </td>
      <td>
        <p>거짓</p>
      </td>
    ...
    <tr>
      ...
      <td>
        <p>[!DNL Marketo Measure] 태그 지정에 대해 Creative을 업데이트해야 하는지 여부입니다.</p>
        <p>(내부 처리에 사용되는 진단 필드)</p>
      </td>
      <td>
        <p>거짓</p>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>텍스트 또는 디스플레이일 수 있는 Creative 유형</p>
      </td>
      <td>
        <p>텍스트</p>
      </td>
...
>[!IMPORTANT]
>
>Marketo Measure은 2024년 중반에 이 표를 더 이상 사용하지 않을 예정입니다. 사용자 측에서 생성하려는 경우 [이 SQL 쿼리](/help/assets/BIZ_FACTS.sql)를 실행하십시오.
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Doubleclick 노출 계층 구조에 Creative이 없으므로 Null이 필요합니다.</p>
      </td>
      <td>
        <p>null</p>
      </td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <p>이 필드는 설정되어 있지 않으며 모든 고객에 대해 Snowflake에서 null을 반환합니다.</p>
      </td>
      <td>
        <p>null</p>
      </td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>_DELETED_DATE</td>
      <td>timestamp_ntz</td>
      <td>삭제된 경우 Snowflake의 삭제된 레코드 날짜</td>
      <td>2020-01-01 01:01:00.000</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>광고가 확인된 Creative ID. 이는 Google AdWords 및 Bing Ads(검색)에 적용됩니다.</p>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>광고가 해결된 Creative의 이름입니다. 이는 Google AdWords 및 Bing Ads(검색)에 적용됩니다.</p>
      </td>
      <td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>varchar</td>
      <td>
        <p>Buyer Touchpoint(BT)에 대한 고유 ID.</p>
      </td>
      <td>
...
**지난 달에 각 채널/하위 채널별로 BT(구매자 접점)가 몇 개나 있었습니까?**
