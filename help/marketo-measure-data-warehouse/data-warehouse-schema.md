---
description: Data Warehouse 스키마
...
>[!IMPORTANT]
>Marketo Measure은 2024년 중반에 이 표를 더 이상 사용하지 않을 예정입니다. 사용자 측에서 생성하려는 경우 [이 SQL 쿼리](/help/data-warehouse/assets/BIZ_FACTS.sql)를 실행하십시오.
