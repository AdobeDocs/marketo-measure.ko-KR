...
특정 서버, 웨어하우스 및 스키마 정보는 [!DNL Marketo Measure] 정보 페이지의 [!DNL Data Warehouse] UI에서 찾을 수 있습니다. 이 페이지를 찾는 방법에 대한 지침은 [여기](/help/data-warehouse-access-reader-account.md){target="_blank"}에 자세히 설명되어 있습니다.
