...
![Adobe Marketo Measure 보고 템플릿 Power BI 파일을 엽니다.](assets/marketo-bi-1.png)

특정 서버, 웨어하우스 및 스키마 정보는 [!DNL Data Warehouse] 정보 페이지의 [!DNL Marketo Measure] UI에서 찾을 수 있습니다. 이 페이지를 찾는 방법에 대한 지침은 [여기](/help/data-warehouse-access-reader-account.md){target="_blank"}에 자세히 설명되어 있습니다.
...
파일을 열 때 입력한 매개 변수는 데이터 웨어하우스에서 테이블을 가져오는 기본 쿼리를 구성하는 데 사용됩니다. [!DNL Snowflake] 인스턴스에 대한 데이터 연결을 설정해야 합니다. 이 경우 사용자 이름 및 암호와 함께 동일한 서버 및 웨어하우스 이름이 필요합니다. 필요한 경우 사용자 이름을 찾고 암호를 재설정하는 위치에 대한 자세한 정보는 [여기](/help/data-warehouse-access-reader-account.md){target="_blank"}에 설명되어 있습니다.
...
![모델로 가져온 데이터를 제한하기 위해 각 테이블이 설정됩니다](assets/marketo-bi-2.png)
...
![Power Query의 데이터에 몇 가지 변형이 적용되었습니다.](assets/marketo-bi-6.png)
...
![Marketo Measure Data Warehouse에 있는 대부분의 테이블에 비정규화된 차원이 있습니다](assets/marketo-bi-7.png)
...
![/붙여넣기 함수 및 필터링입니다.](assets/marketo-bi-8.png)

![/붙여넣기 함수 및 필터링입니다.](assets/marketo-bi-11.png)
...
![Snowflake에 저장된 전환율 테이블에 날짜 범위가 포함되어 있습니다](assets/marketo-bi-9.png)

## 데이터 모델 {#data-model}

전체 크기 버전을 보려면 아래 이미지를 클릭하십시오.

[![전체 크기 버전을 보려면 아래 이미지를 클릭하십시오.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![이 모델의 통화 전환 측정값은 1.0](assets/marketo-bi-13.png) 값으로 대체됩니다.

## 데이터 정의 {#data-definitions}

테이블, 사용자 정의 열 및 측정값에 대한 Power BI 모델에 정의가 추가되었습니다.

![사용자 지정 테이블에 대한 Power BI 모델에 정의가 추가되었습니다](assets/marketo-bi-15.png)

![사용자 지정 테이블에 대한 Power BI 모델에 정의가 추가되었습니다](assets/marketo-bi-16.png)

![사용자 지정 테이블에 대한 Power BI 모델에 정의가 추가되었습니다](assets/marketo-bi-14.png)

[!DNL Snowflake]에서 직접 가져오는 열에 대한 정의를 보려면 [데이터 웨어하우스 설명서](/help/data-warehouse-schema.md){target="_blank"}를 참조하세요.
