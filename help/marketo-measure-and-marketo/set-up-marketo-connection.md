...
1. [!DNL Marketo Measure]에서 **[!UICONTROL My Account]** 드롭다운을 클릭하고 **[!UICONTROL Settings]**&#x200B;을(를) 선택합니다.
   ...
   설정 옵션이 있는 ![Marketo Measure 내 계정 드롭다운](assets/set-up-marketo-connection-1.png)

1. [!UICONTROL Integrations]에서 **[!UICONTROL Connections]**&#x200B;을(를) 클릭합니다.

   ![연결 옵션이 있는 통합 메뉴](assets/set-up-marketo-connection-2.png)

1. **[!UICONTROL Set Up New CRM Connection]**&#x200B;를 클릭합니다.

   ![새 CRM 연결 설정 단추](assets/set-up-marketo-connection-3.png)

1. Marketo 옆에 있는 **[!UICONTROL Connect]** 단추를 클릭합니다.

   ![Marketo 통합 옵션 옆에 있는 연결 단추](assets/set-up-marketo-connection-4.png)

1. 새 탭에서 Marketo Engage 계정에 로그인합니다. **관리자** > **웹 서비스**(으)로 이동합니다. REST API로 스크롤합니다. 끝점 및 ID 서비스 URL을 강조 표시하고 저장합니다. 다음 단계에서 필요합니다.

   ![REST API 끝점 및 ID URL을 표시하는 Marketo 웹 서비스 페이지](assets/set-up-marketo-connection-5.png)

1. Marketo Engage에서 왼쪽의 트리에서 **LaunchPoint**&#x200B;을(를) 선택하십시오. Marketo Measure에 연결할 사용자 지정 서비스를 찾은 다음 **세부 정보 보기**&#x200B;를 클릭합니다.

   사용자 지정 서비스 및 세부 정보 보기 옵션이 있는 ![LaunchPoint 메뉴](assets/set-up-marketo-connection-6.png)

1. 클라이언트 ID 및 클라이언트 암호를 강조 표시하고 저장합니다. Click **Close**.

   ![클라이언트 ID 및 클라이언트 암호를 보여주는 LaunchPoint 서비스 세부 정보](assets/set-up-marketo-connection-7.png)

1. [!DNL Marketo Measure]&#x200B;(으)로 돌아가서 수집한 데이터로 필드를 채웁니다.

   끝점 및 자격 증명 필드가 있는 ![Marketo 연결 양식](assets/set-up-marketo-connection-8.png)

1. 값을 입력한 후 **[!UICONTROL Authenticate]**&#x200B;을(를) 클릭합니다. Marketo Engage 계정이 [!DNL Marketo Measure]에 연결되어 있습니다.

   ![Marketo 연결 확인 메시지 성공](assets/set-up-marketo-connection-9.png)
