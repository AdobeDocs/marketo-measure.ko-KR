...
* SOLR이 활성화되었습니다([Marketo 지원](https://nation.marketo.com/t5/Support/ct-p/Support){target="_blank"}에 연락하여 활성화하십시오).
...
![Marketo과 CRM 리드 합계를 보여 주는 Marketo Measure Discover 대시보드](assets/bizible-discover-1.png)

![Source 시스템 세그먼트를 강조 표시하는 필터 검색](assets/bizible-discover-2.png)
