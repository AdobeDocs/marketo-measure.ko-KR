---
description: 각 영업 단계에서 시간을 추적하고 시간에 따른 채널별 트렌드를 비교하기 위한 Opportunity Velocity 대시보드에 대해 설명합니다.
title: 영업 기회 속도 대시보드
feature: Reporting
...
![기회 만들기 이전 단계에서 가장 최근 터치포인트 날짜가](assets/lead-dashboard-1.png)(으)로 사용됩니다.
...
![영업 기회에서 가장 빠른 성과를 거둔 달](assets/lead-dashboard-2.png)
...
![&#39;잠재 고객&#39; 단계의 영업 기회 속도가 서로 어떻게 다릅니까](assets/lead-dashboard-3.png)
