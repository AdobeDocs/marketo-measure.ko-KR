...
![웹 사이트에서 고유 항목 수가 가장 많이 표시된 기간](assets/web-dashboard-1.png)
...
![양식에서 리드 만들기](assets/web-dashboard-2.png)
...
![고유 방문자 수](assets/web-dashboard-3.png)
...
![고유 방문자 수를 &#x200B;](assets/web-dashboard-4.png) 내의 총 방문 횟수와 어떻게 비교합니까?
