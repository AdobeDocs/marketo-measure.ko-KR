...
![다른 마케팅 채널 및 캠페인에 따라 표시되는 고유 전화 번호를 보여 주는 다이어그램](assets/1.png)
...
![CallTrackingMetrics 통합이 없는 전화 통화 추적을 CallTrackingMetrics 통합과 비교하는 순서도 전후](assets/2.png)
...
![값으로 채워진 BizibleId 필드를 보여주는 Salesforce 작업 레코드 예](assets/3.png)
...
![병합된 웹 세션 및 전화 통화 데이터의 통화 유형을 표시하는 터치포인트 레코드](assets/4.png)
...
![채널별 통화 생성 매출을 추적하기 위한 전화 통화를 포함한 접점 유형을 표시하는 보고서](assets/5.png)
...
![광고 클릭과 전화 통화 사이의 30분 웹 세션 시간 제한 기간을 보여 주는 다이어그램](assets/6.png)
