...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>주어진 사용자와 연계된 오픈 기회 중 가장 깊은 funnel 단계입니다.</td>
  </tr>
  <tr> 
   <td>영업 기회 열기</td> 
...
1. Content Analytics: 매출 지표를 사용하여 제품이나 서비스를 최종적으로 구매하는 고객 또는 특정 funnel 관심 단계에 도달한 고객에게 가장 매력적인 사이트 콘텐츠를 분석합니다.
1. 라이브 딜 지원: CRM의 특정 진행 중인 영업 기회와 연관된 사용자의 사이트 동작을 분석하여 영업 팀에 실행 가능한 insight을 제공합니다.
