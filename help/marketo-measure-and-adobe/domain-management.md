...
![유효성 검사 상태를 표시하는 Adobe Admin Console 도메인 목록](assets/domain-management-1.png)
...
![활성화된 전환이 있는 확인된 도메인을 나열하는 Marketo Measure 도메인 페이지](assets/domain-management-2.png)
...
Marketo Measure에서 도메인을 사용하지 않도록 설정할 때 ![확인 대화 상자](assets/domain-management-3.png)
