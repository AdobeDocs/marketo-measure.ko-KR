...
![Opportunity에 대한 시간 경과에 따라 MQL 및 SQL 부메랑 접점을 표시하는 리드 여정 다이어그램](assets/1-1.png)
...
![사용자 지정 단계로 추적된 MQL 및 SAL이 있는 SQL 부메랑 접점을 표시하는 리드 여정](assets/2-1.png)
...
![SAL 및 OC 위치가 동일한 터치포인트에서 결합된 건너뛴 SAL 단계를 표시하는 리드 여정](assets/3.png)
...
![Opportunity로 번역하는 MQL 및 SAL 부메랑 터치포인트를 보여 주는 3가지 리드 여정 다이어그램](assets/4.png)
...
![Opportunity에서 위치 번호가 매겨진 MQL, SQL 및 SAL 부메랑 접점을 보여 주는 리드 여정 3개](assets/5.png)
...
![SQL 단계 후 발생할 때 Opportunity에서 제외된 웹 방문 부메랑 접점을 표시하는 리드 여정 3개](assets/6.png)
...
![여러 단계 전환으로 부메랑 속성 가중치를 표시하는 리드 여정 3개](assets/7.png)
...
![Opportunity에서 OC 접점 다음에 표시되는 데모 및 협상 부메랑 접점을 보여 주는 연락처 여정](assets/8.png)
