...
1. 설정에서 [빠른 찾기] 상자에 &quot;흐름&quot;을 입력하고 **[!UICONTROL Flows]**&#x200B;을(를) 선택하여 흐름 빌더를 시작합니다. 오른쪽 패널에서 **[!UICONTROL New Flow]** 단추를 클릭합니다.
   ...
   ![새 흐름 단추가 있는 Salesforce 흐름 빌더](assets/using-a-custom-revenue-amount-field-1.png)

1. **[!UICONTROL Record-Triggered Flow]**&#x200B;을(를) 선택하고 오른쪽 하단의 **[!UICONTROL Create]**&#x200B;을(를) 클릭합니다.

   ![레코드 트리거된 흐름 옵션이 있는 흐름 유형 선택](assets/using-a-custom-revenue-amount-field-2.png)
...
1. Configure Start 창에서 Opportunity 객체를 선택합니다. [!UICONTROL Configure Trigger] 섹션에서 **[!UICONTROL A record is created or updated]**&#x200B;을(를) 선택합니다.
   ...
   ![영업 기회 개체가 선택된 상태로 시작 창 구성](assets/using-a-custom-revenue-amount-field-3.png)
...
1. 시작 조건 설정 섹션의 [!UICONTROL Condition Requirements]에서 **[!UICONTROL Custom Condition Logic Is Met]**&#x200B;을(를) 선택합니다.
   ...
   * 평가 기준을 **[!UICONTROL Every time a record is updated and meets the condition requirements]**(으)로 설정합니다.
   ...
   사용자 지정 조건 논리를 사용한 ![시작 조건 구성](assets/using-a-custom-revenue-amount-field-4.png)

1. &quot;다음에 대한 흐름 최적화&quot; 섹션에서 **[!UICONTROL Fast Field Updates]**&#x200B;을(를) 선택합니다. 오른쪽 하단의 **[!UICONTROL Done]**&#x200B;을(를) 클릭합니다.

   ![빠른 필드 업데이트를 사용하여 흐름 설정 최적화](assets/using-a-custom-revenue-amount-field-5.png)

1. 요소를 추가하려면 더하기(+) 아이콘을 클릭하고 **[!UICONTROL Update Triggering Record]**&#x200B;을(를) 선택합니다.

   ![레코드 트리거 업데이트 옵션이 있는 흐름 요소 메뉴](assets/using-a-custom-revenue-amount-field-6.png)
...
1. 신규 레코드 갱신 창에서 다음을 입력합니다.
   ...
   * **[!UICONTROL Done]**&#x200B;를 클릭합니다.
   ...
   ![필드 값 매핑으로 레코드 구성 업데이트](assets/using-a-custom-revenue-amount-field-7.png)

1. **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다. 팝업이 나타납니다. 흐름 저장 창에 &quot;흐름 레이블&quot;을 입력합니다(흐름 API 이름이 자동으로 생성됨). **[!UICONTROL Save]**&#x200B;을(를) 다시 클릭합니다.

   ![레이블 필드가 있는 흐름 대화 상자 저장](assets/using-a-custom-revenue-amount-field-8.png)

1. 흐름을 활성화하려면 **[!UICONTROL Activate]** 단추를 클릭하십시오.

   ![활성화 단추가 있는 흐름 요약 페이지](assets/using-a-custom-revenue-amount-field-9.png)
...
1. **[!UICONTROL Setup]** > **[!UICONTROL Create]** > **[!UICONTROL Workflow & Approvals]** > **[!UICONTROL Workflow Rules]**(으)로 이동합니다.
   ...
   ![워크플로 규칙을 표시하는 Salesforce 클래식 탐색 메뉴](assets/using-a-custom-revenue-amount-field-10.png)

1. **[!UICONTROL New Rule]**&#x200B;을(를) 선택하고 개체를 &quot;Opportunity&quot;로 설정한 다음 **[!UICONTROL Next]**&#x200B;을(를) 클릭합니다.

   ![새 규칙이 있는 워크플로 규칙 페이지](assets/using-a-custom-revenue-amount-field-11.png)

   ![Opportunity로 설정된 워크플로 규칙에 대한 개체 선택](assets/using-a-custom-revenue-amount-field-12.png)
...
1. 워크플로우를 구성합니다. 규칙 이름을 &quot;Update [!DNL Marketo Measure] Opportunity Amount&quot;로 설정합니다. 평가 기준을 &quot;만들어짐, 편집할 때마다&quot;로 설정합니다. 규칙 기준에 대해 사용자 지정 금액 필드를 선택하고 연산자 [!UICONTROL as "Not Equal To"]을(를) 선택한 후 &quot;값&quot; 필드를 비워 둡니다.
   ...
   ![규칙 조건 및 평가 설정이 있는 워크플로 구성](assets/using-a-custom-revenue-amount-field-13.png)

1. 워크플로우 작업을 추가합니다. 이 선택 목록을 &quot;[!UICONTROL New Field Update]&quot;(으)로 설정합니다.
   ![새 필드 업데이트 옵션이 있는 워크플로우 작업 추가 대화 상자](assets/using-a-custom-revenue-amount-field-14.png)
...
1. 여기에서 필드 정보를 입력합니다. &quot;이름&quot; 필드에서는 &quot;[!DNL Marketo Measure] Opp 금액&quot; 이름을 사용하는 것이 좋습니다. &quot;고유 이름&quot;은 &quot;이름&quot; 필드를 기반으로 자동으로 채워집니다. &quot;업데이트할 필드&quot; 선택 목록에서 &quot;[!DNL Marketo Measure] 영업 기회 금액&quot;을 선택합니다. 필드를 선택한 후 &quot;필드 변경 후 워크플로우 규칙 재평가&quot; 상자를 선택합니다. &quot;새 필드 값 지정&quot;에서 &quot;새 값을 설정하려면 수식 사용&quot;을 선택합니다. 빈 상자에 사용자 정의 금액 필드의 API 이름을 놓습니다. **[!UICONTROL Save]**&#x200B;를 클릭합니다.
   ...
   ![이름, 필드 매핑 및 수식 설정을 표시하는 필드 업데이트 구성](assets/using-a-custom-revenue-amount-field-15.png)
