...
[!DNL Salesforce] 인스턴스 내에서 ABM을 설정하는 방법에 대한 자세한 지침은 [Salesforce에서 ABM 페이지 레이아웃 설정](/help/advanced-features/account-based-marketing/account-based-marketing-overview.md#setting-up-abm-page-layout-in-salesforce){target="_blank"}으로 이동하십시오.
...
1. [!UICONTROL Fields]&#x200B;(으)로 이동하여 &quot;예측 참여 점수&quot; 필드를 계정 정보 섹션으로 이동하십시오.
   ...
   ![예측 참여 점수 필드를 표시하는 계정 페이지 레이아웃](assets/1.png)

1. 마지막으로 [!UICONTROL Related Lists]&#x200B;(으)로 이동하여 &quot;잠재 고객&quot; 관련 목록을 페이지 레이아웃으로 이동합니다.

   ![계정 페이지 레이아웃에 리드 관련 목록 추가](assets/2.png)
...
1. **[!UICONTROL Fields]**&#x200B;을(를) 클릭하고 페이지에 맞는 [!UICONTROL Account] 필드를 추가합니다.
   ...
   ![계정 필드가 추가된 리드 페이지 레이아웃](assets/3.png)
