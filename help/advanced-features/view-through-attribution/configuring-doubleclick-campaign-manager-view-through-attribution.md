---
description: Marketo Measure 사용자를 위한 속성 지침을 통해 Doubleclick Campaign Manager 보기 구성
...
>[!NOTE]
>
>[!DNL Marketo Measure] 및 [!DNL DoubleClick Campaign Manager] 통합을 사용하는 경우 [API 연결](/help/api-connections/integrated-ad-platforms.md#how-to-connect-ad-platforms)이 필요하므로 광고 해결을 위해 캠페인 및 광고 크리에이티브의 세부 정보를 다운로드할 수 있습니다.

[!DNL Doubleclick Campaign Manager]을(를) 사용한 추적을 통해 보기에서 더 세분화된 insight을 얻으려면 추적 픽셀을 구성해야 합니다.

[!DNL Marketo Measure] 속성을 통한 보기 기능에 대한 자세한 내용은 [속성을 통한 Marketo Measure 보기 FAQ](/help/advanced-features/view-through-attribution/marketo-measure-view-through-attribution-faq.md)를 참조하십시오.
