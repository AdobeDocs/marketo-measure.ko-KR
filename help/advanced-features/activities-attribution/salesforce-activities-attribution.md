...
![속성 규칙에 대한 활동 구성 페이지를 표시하는 설정 탭](assets/1.png)
...
![아웃바운드 매출에 대한 동적 대체 매개 변수가 있는 캠페인 이름 필드](assets/2.png)
...
![및/또는 문 옵션이 있는 필터 조건을 표시하는 활동 규칙 구성 인터페이스](assets/3.png)
...
![표준 및 사용자 지정 날짜 필드 옵션을 보여 주는 Buyer Touchpoint 날짜 필드 선택](assets/4.png)

작업 또는 이벤트에 대해 다른 규칙을 설정하는 것을 잊지 마십시오. 영업 팀이 활동을 기록하기 위해 사용하는 객체를 알고 있어야 합니다.

![활동 규칙에 대한 작업 및 이벤트 옵션을 표시하는 개체 유형 선택기](assets/5.png)
...
와일드카드 연산자 옵션을 사용한 캠페인 매핑을 보여 주는 ![마케팅 채널 구성 페이지](assets/6.png)
...
![ROI 추적을 사용하여 월별 채널 비용을 입력하기 위한 마케팅 비용 업로드 인터페이스](assets/7.png)
