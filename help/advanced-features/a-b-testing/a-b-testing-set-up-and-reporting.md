...
1. 리드 페이지 레이아웃을 편집하고 **[!DNL Marketo Measure]A/B 테스트** 관련 목록을 페이지에 추가하십시오.
   ...
   ![추가 중인 Marketo Measure A/B 테스트 관련 목록을 표시하는 리드 페이지 레이아웃 편집기](assets/1.png)
...
1. [!UICONTROL Wrench] 단추를 클릭합니다. 선택한 필드 목록에서 스톡 &quot;ID&quot; 필드를 제거합니다. **[!UICONTROL Experiment]**, **[!UICONTROL Variation]** 및 **[!UICONTROL DateReported]** 필드를 추가합니다. &quot;[!UICONTROL Sort by]&quot;을(를) **[!UICONTROL Date Reported]**(으)로 변경하고 드롭다운에서 **[!UICONTROL Descending]**&#x200B;을(를) 선택합니다.
   ...
   정렬 설정이 있는 실험, 변형 및 DateReported 필드를 표시하는 ![필드 구성 대화 상자](assets/2.png)

1. [!UICONTROL Buttons]에서 **[!UICONTROL New]** 선택을 취소합니다.

   ![선택 취소되는 새 단추를 표시하는 단추 섹션](assets/3.png)
...
![잠재 고객, 연락처 및 기회에 대한 Marketo Measure A/B 테스트 보고서 유형을 보여주는 보고서 목록](assets/4.png)
...
다음은 A/B 테스트에 대해 보고할 때 명확성과 insight을 높이는 데 사용할 몇 가지 권장 필드입니다.
...
![실험 및 변형을 포함한 잠재 고객 데이터가 포함된 Marketo Measure A/B 테스트를 보여 주는 Salesforce 보고서 예](assets/5.png)

**[!DNL Marketo Measure]A/B 테스트(영업 기회 포함)**

![매출 영향을 포함한 영업 기회 데이터가 있는 Marketo Measure A/B 테스트를 보여 주는 Salesforce 보고서 예](assets/6.png)
