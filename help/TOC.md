...
+ [!DNL Marketo Measure] 추적 {#marketo-measure-tracking}
   + 추적 설정 {#setting-up-tracking}
      ...
      + 다른 양식 공급자에 [!DNL Marketo Measure] 스크립트를 추가하는 중 {#adding-marketo-measure-script-to-different-form-providers}
         ...
         + [Uberflip Forms에  [!DNL Marketo Measure] 스크립트 추가 중](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-uberflip-forms.md)
         + [Act-On Forms에  [!DNL Marketo Measure] 을(를) 추가하는 중](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-act-on-forms.md)
         + [Hubspot에  [!DNL Marketo Measure] 추가 중](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-hubspot.md)
         + [Marketo 랜딩 페이지에  [!DNL Marketo Measure] 을(를) 추가하는 중](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-marketo-landing-pages.md)
         ...
         + [언바운스 스크립트 관리자에  [!DNL Marketo Measure] 연결 중](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/connecting-marketo-measure-to-unbounce-script-manager.md)
      ...
      + [특정 Forms에서  [!DNL Marketo Measure] 개 제외](marketo-measure-tracking/setting-up-tracking/excluding-marketo-measure-from-specific-forms.md)
...
+ 구성 및 설정 {#configuration-and-setup}
   + [!DNL Marketo Measure] 시작 {#getting-started-with-marketo-measure}
      ...
      + [BT 및 [!DNL BATs]의 접점 위치 및 생성에 대한 설명](configuration-and-setup/getting-started-with-marketo-measure/explanation-of-touchpoint-positions-and-generation-across-bts-and-bats.md)
...
+ API 연결 {#api-connections}
   + [!DNL Marketo Measure]의 API 연결 사용 중 {#utilizing-marketo-measures-api-connections}
      ...
      + [ [!DNL Marketo Measure] AdWords 태그 지정 이해](api-connections/utilizing-marketo-measures-api-connections/understanding-marketo-measure-adwords-tagging.md)
...
+ 고급 [!DNL Marketo Measure] 기능 {#advanced-marketo-measure-features}
   ...
   + 접점 설정 {#touchpoint-settings}
      ...
      + [접점 제거 및 접점 억제](advanced-marketo-measure-features/touchpoint-settings/touchpoint-removal-and-touchpoint-suppression.md)
   ...
   + A/B 테스트 {#a-b-testing}
      ...
      + [ [!DNL Marketo Measure] A/B 테스트 통합 구성](advanced-marketo-measure-features/a-b-testing/configuring-the-marketo-measure-a-b-test-integration.md)
...
+ [!DNL Marketo Measure] 및 Adobe {#marketo-measure-and-adobe}
   + [Adobe Analytics과 [!DNL Marketo Measure] 통합](marketo-measure-and-adobe/marketo-measure-integrations-with-adobe-analytics.md)
...
+ [!DNL Marketo Measure] Salesforce 보고 {#marketo-measure-salesforce-reporting}
   + 새 보고서 유형 {#new-report-types}
      + [사용자 지정 [!DNL Marketo Measure] 보고서 유형을 만드는 중](marketo-measure-salesforce-reporting/new-report-types/creating-custom-marketo-measure-report-types.md)
...
+ 보안 및 규정 준수 {#security-and-compliance}
   + 규정 준수 관련 리소스 {#compliance-related-resources}
      ...
      + [ [!DNL Marketo Measure] Js에서 GDPR에 대한 동의 확인](security-and-compliance/compliance-related-resources/ensuring-consent-for-gdpr-in-marketo-measure-js.md)
