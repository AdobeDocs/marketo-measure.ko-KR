...
* Kenshoo 또는 Marin과 같은 추적 템플릿에 서드파티 리디렉션이 있으면 [!DNL Marketo Measure]이(가) 아무 작업도 수행하지 않습니다. 대신 계정의 타사 도구에 [매개 변수를 추가 [!DNL Marketo Measure] 해야 합니다](/help/api-connections/how-bid-management-tools-affect-marketo-measure.md){target="_blank"}.
