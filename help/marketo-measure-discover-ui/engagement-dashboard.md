...
* **구매자 접점**: 리드 및 연락처 속성에 대해 선택한 접점. BT는 Opportunity에 연결되어 있지 않으며 관련 매출도 없습니다.
* **구매자 속성 접점**: 기회 속성에 대해 선택한 접점. BAT는 Opportunity에 연결되어 있어 매출에 영향을 미칩니다.
...
![터치포인트 및 사용자가 터치한 참여 대시보드 시계열](assets/engagement-dashboard-1.png)
...
![채널별 터치포인트 및 사람들의 참여 대시보드 막대 차트](assets/engagement-dashboard-2.png)
