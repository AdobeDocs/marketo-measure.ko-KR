...
![판매 단계 막대 차트별 잠재 고객 또는 연락처 속도](assets/lead-velocity-dashboard-1.png)
...
![타임라인 차트에 따른 잠재 고객 속도 트렌드](assets/lead-velocity-dashboard-2.png)
...
![채널별 잠재 고객 속도 비교 차트](assets/lead-velocity-dashboard-3.png)
