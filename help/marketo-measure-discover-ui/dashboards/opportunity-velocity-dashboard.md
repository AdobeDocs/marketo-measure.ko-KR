...
Velocity 대시보드는 잠재 고객이 판매 funnel을 통해 이동하는 속도에 대한 동적 보기를 제공하여 마케터와 영업 팀이 다양한 채널에서 전환 시간에 대한 중요한 통찰력을 얻을 수 있습니다. 이 툴은 영업 단계에서 영업 기회 수명주기 및 진행 효율성에 대한 주요 질문에 답하는 데 유용합니다. 이를 통해 여러분은 성장 및 전환 가속화를 위한 참여 전략을 최적화할 수 있습니다.
...
막대 차트에는 리드/연락처가 각 funnel 단계에 채널별로 분류된 평균 지속 기간(일)이 표시됩니다.

* 마우스를 라인 위로 가져가면 자세한 정보가 표시됩니다.

이 차트가 답하는 질문:

* funnel 스테이지를 통해 가장 빠르게 진행되는 채널은 무엇입니까?
