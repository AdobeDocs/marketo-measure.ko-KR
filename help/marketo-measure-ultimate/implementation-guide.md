...
>[!NOTE]
>스키마, 클래스 및 필드 그룹에 대한 개요는 [스키마 빌딩 블록](https://experienceleague.adobe.com/docs/experience-platform/xdm/schema/composition.html?lang=en#building-blocks-of-a-schema){target="_blank"}을 확인하십시오.
