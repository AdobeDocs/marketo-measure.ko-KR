---
description: Microsoft Dynamics CRM에 Marketo Measure 패키지를 설치하고 구성하는 단계별 안내서
...
1. [!UICONTROL Credentials] 또는[!UICONTROL OAuth]를 선택합니다.
   ...
   >[!NOTE]
   >
   >OAuth에 대한 자세한 내용은 [이 문서](/help/oauth-with-azure-active-directory-for-dynamics-crm.md)를 참조하세요. 프로세스에 대한 질문이 있는 경우 [!DNL Marketo Measure] 계정 담당자에게 문의하십시오.
...
1. 전화 번호를 입력합니다. 웹 사이트의 경우 웹 사이트에서 [!DNL Marketo Measure] 추적에 사용되는 주 루트 도메인을 입력하십시오. 완료되면 **[!UICONTROL Save]**&#x200B;를 클릭합니다.
