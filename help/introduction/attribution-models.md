---
description: Marketo Measure 속성 모델
...
![첫 번째 접점, 잠재 고객 만들기, 영업 기회 만들기, 마감의 네 가지 마일스톤 접점을 표시하는 고객 여정 타임라인](assets/overview-resources-8.png)
...
![Adwords 채널에 대한 100% 속성 크레딧을 보여 주는 첫 번째 터치 모델 다이어그램](assets/overview-resources-9.png)
...
![LinkedIn 채널에 대한 100% 속성 크레딧을 보여 주는 잠재 고객 생성 모델 다이어그램](assets/overview-resources-10.png)
...
Adwords에 대한 50% 크레딧 및 LinkedIn에 대한 50%를 보여 주는 ![U자형 모델 다이어그램](assets/overview-resources-11.png)
...
![FT, LC 및 OC 접점에 대한 각각 30% 크레딧과 중간 접점에 대한 10%를 보여주는 W자형 모델 다이어그램](assets/overview-resources-12.png)
...
![FT, LC, OC 및 CW 접점에 대한 22.5% 크레딧과 중간 접점에 대한 10%를 보여주는 전체 경로 모델 다이어그램](assets/overview-resources-13.png)
