---
description: Marketo Measure 사용자를 위한 오프라인 캠페인 지침 동기화
title: 오프라인 캠페인 동기화
...
![업로드 날짜가 회의 날짜보다 3주 늦습니다.](assets/dynamics-lists-1.png)
...
![터치포인트를 사용하려면 먼저 터치포인트 날짜를 업데이트하세요.](assets/dynamics-lists-10.png)
...
![Salesforce에서 캠페인을 만들려면 캠페인으로 이동합니다](assets/dynamics-lists-2.png)
