---
description: Marketo Measure 사용자를 위한 Dynamics Campaigns and Marketing Lists 지침
...
>[!NOTE]
>
>이 문서에서는 오래된 프로세스를 다룹니다. 사용자가 [새롭고 개선된 인앱 프로세스](/help/channel-tracking-and-setup/custom-campaign-sync.md){target="_blank"}를 사용하는 것이 좋습니다.
...
![잠재 고객 또는 연락처가 Campaign에 직접 추가되면 입력됩니다](assets/dynamics-lists-1.png)
...
![터치포인트 여정에 이러한 레코드를 포함하려면 몇 가지 &#x200B;](assets/dynamics-lists-10.png)을(를) 사용합니다.
...
![Marketo Measure은 사용자 지정 응답 값을 지원하지 않습니다.](assets/dynamics-lists-2.png)

캠페인 응답에 대한 재고 응답 값은 다음과 같습니다.

![캠페인 응답에 대한 재고 응답 값:](assets/dynamics-lists-3.png)입니다.
...
![이 필드를 사용하는 일반적인 예 중 하나는 목록이 있는 이벤트용입니다](assets/dynamics-lists-4.png)
...
![Marketo Measure은 정적 마케팅 목록만 지원합니다. &#x200B;](assets/dynamics-lists-5.png)을(를) 지원하지 않습니다.
...
![터치포인트에 대한 마케팅 목록을 활성화하려면 별도의 설정이 있습니다](assets/legacy-processes-10.png)
...
![마케팅 목록에 대한 터치포인트 날짜는 일반적으로 만들어진 ListMember입니다](assets/dynamics-lists-6.png)
...
![각 캠페인 유형에 대해 채널에 매핑할 수 있으며](assets/dynamics-lists-7.png)

![각 캠페인 유형에 대해 채널에 매핑할 수 있으며](assets/dynamics-lists-8.png)
