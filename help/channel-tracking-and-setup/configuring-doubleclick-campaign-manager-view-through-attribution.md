...
>[!NOTE]
>
>[!DNL Marketo Measure] 및 [!DNL DoubleClick Campaign Manager] 통합을 사용하는 경우 [API 연결](/help/api-connections/integrated-ad-platforms.md)이 필요하므로 광고 해결을 위해 캠페인 및 광고 크리에이티브의 세부 정보를 다운로드할 수 있습니다.

[!DNL Doubleclick Campaign Manager]을(를) 사용한 추적을 통해 보기에서 더 세분화된 insight을 얻으려면 추적 픽셀을 구성해야 합니다.

[!DNL Marketo Measure] 속성을 통한 보기 기능에 대한 자세한 내용은 [속성을 통한 Marketo Measure 보기 FAQ](/help/channel-tracking-and-setup/marketo-measure-view-through-attribution-faq.md)를 참조하십시오.
...
1. 추가되면 다음과 같이 구분 기호가 매핑되는지 확인합니다. 태그가 적용되면 자동으로 설정되어야 합니다.
   ...
   ![n = %n 난수 매크로](assets/view-attribution-1.png)
