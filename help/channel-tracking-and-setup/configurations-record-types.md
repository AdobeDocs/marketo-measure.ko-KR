---
description: Marketo Measure 사용자를 위한 여러 Campaign 레코드 유형 지침 구성
...
SFDC 조직에서 여러 캠페인 레코드 유형을 사용하는 경우 각 레코드 유형에 대해 &quot;구매자 접점 활성화&quot;에 대한 선택 목록 값을 추가해야 합니다. 옵션을 추가하려면 아래 단계를 따르십시오.

1. **[!UICONTROL Setup]** > **[!UICONTROL Customize]** > **[!UICONTROL Campaigns]** > **[!UICONTROL Record Types]**(으)로 이동합니다.

   ![1. 캠페인 레코드 유형 사용자 지정으로 이동합니다.](assets/offline-channels-19.jpg)

1. **[!UICONTROL Record Type Label]** 단추가 아닌 [!UICONTROL edit]을(를) 클릭하여 캠페인 레코드 유형을 선택하십시오.

   ![1. 레코드 종류](assets/offline-channels-15.jpg)을(를) 클릭하여 Campaign 레코드 종류 선택
