---
description: Marketo Measure 사용자를 위한 사용자 정의 Campaign 동기화 지침
...
1. **+** 아이콘을 클릭하여 규칙 만들기를 시작합니다.
   ...
   ![1. 규칙을 만들려면 + 아이콘을 클릭합니다.](assets/offline-channels-1.png)
...
1. [!UICONTROL Campaign] 또는 [!UICONTROL Campaign Member] 필드에서 규칙을 만들 수 있습니다. 유효성 검사가 예상되는 연산자 및 값으로 규칙의 나머지 부분을 채웁니다. 아래 예에서는 이름으로 특정 Campaign을 확인하고 있습니다.
   ...
   ![1. Campaign](assets/offline-channels-10.jpg)에서 규칙을 만들 수 있습니다.
...
1. 접점 날짜를 선택합니다. 중괄호 `{`을(를) 입력한 후 가능한 날짜 목록이 나타납니다. 그러면 규칙에서 만든 모든 터치포인트에 적용할 날짜를 선택할 수 있습니다.
   ...
   ![1. 접점 날짜를 선택합니다. 가능한 날짜 목록이 나타납니다](assets/offline-channels-11.png)
...
1. 확인 표시를 클릭한 다음 필요에 따라 추가 캠페인에 대한 규칙을 추가합니다.
   ...
   ![이제 규칙이 CRM 동기화와 함께 정의되었으므로](assets/offline-channels-13.png)
...
![구매자 터치포인트 및 Buyer Attribution Touchpoint 기록을 쉽게 확인할 수 있습니다](assets/offline-channels-14.png)
...
1. Campaign 동기화 기능에는 테스트 기능이 포함되어 있으므로 만든 규칙이 실제로 Campaign 기준에 맞는지 확인할 수 있습니다. [!UICONTROL Test] 단추를 클릭하여 시작합니다. 테스트를 시작하려면 먼저 규칙을 저장해야 합니다.
   ...
   ![Campaign ID를 입력할 수 있는 팝업이 나타납니다(](assets/offline-channels-16.png)).
