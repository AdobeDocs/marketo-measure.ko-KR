---
description: Marketo Measure 사용자를 위한  [!DNL Marketo Measure] A/B 테스트 통합 지침 구성
...
# [!DNL Marketo Measure] A/B 테스트 통합 구성 {#configuring-a-b-testing}
...
1. 패키지 [[!DNL Marketo Measure] v3.9 이상을 사용 중인지 확인](https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3000000B3KLuEAN){target="_blank"}합니다.
