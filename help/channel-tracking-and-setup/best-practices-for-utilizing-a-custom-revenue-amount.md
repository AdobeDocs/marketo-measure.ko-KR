...
>[!MORELIKETHIS]
>
>* [사용자 지정 수익 금액 필드 사용](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
>* [데이터 로더를 사용하여 사용자 지정 금액 필드 업데이트](/help/channel-tracking-and-setup/using-data-loader-to-update-marketo-measure-custom-amount-field.md)
>* [다중 통화 개요](/help/channel-tracking-and-setup/overview.md)
>* [다중 통화 설정](/help/channel-tracking-and-setup/settings.md)
