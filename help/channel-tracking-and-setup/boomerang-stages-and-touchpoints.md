...
>[!NOTE]
>
>[부메랑 단계를 설정하는 방법에 대한 지침](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md).
...
![부메랑 단계(&quot;이전&quot;)가 없으면 가장 최근 MQL만 표시됩니다](assets/boomerang-stages-18.png)
...
![아래 예를 사용하여 이 Marketo Measure 계정에 MQL이 포함되었습니다](assets/boomerang-stages-19.png)
...
[!DNL Marketo Measure]의 처리 제한으로 인해 이 상한은 Data Warehouse 및 CRM에 적용됩니다. Data Warehouse 역시 한 단계당 터치포인트가 10개로 제한된다.
