...
![스프레드시트에 세 개의 열이 있습니다.](assets/offline-channels-1.png)
...
[!DNL Marketo Measure] 오프라인 채널 논리는 Campaign 개체, 특히 [!DNL Salesforce] 캠페인 유형에 의해 결정됩니다. [!DNL Salesforce]은(는) 이 필드를 사용하여 매핑할 채널 및 하위 채널을 이해하기 때문에 각 오프라인 작업에는 저녁 식사 또는 박람회 같은 [!DNL Marketo Measure] 캠페인 유형이 있어야 합니다.
...
![나열된 오프라인 채널의 탭에 SFDC 캠페인 유형이 나타납니다](assets/offline-channels-10.jpg)
...
![다음은 Marketo Measure이 수행하지 않을 논리의 예입니다](assets/offline-channels-12.png)

위의 시나리오에서는 동일한 캠페인 유형을 두 개의 서로 다른 하위 채널에 매핑할 수 없으므로 고유한 캠페인 유형을 만들려고 합니다. 대신 다음과 같은 고유한 유형을 설정해야 합니다.

![위의 시나리오에서는 고유한 캠페인을 만듭니다](assets/offline-channels-13.png)
...
[오프라인 동기화 [!DNL Salesforce] 캠페인  [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)에 대해 자세히 알아보세요.
