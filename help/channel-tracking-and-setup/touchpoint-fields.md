---
description: Marketo Measure 사용자를 위한 터치포인트 필드 지침
title: 접점 필드
...
![Marketo Measure 설정 메뉴에서 터치포인트 필드로 이동](assets/touchpoint-fields-1.png)
...
![{6}은(는) 추출 중인 문자 수입니다.](assets/touchpoint-fields-12.png)
...
![{6}은(는) 추출 중인 문자 수입니다.](assets/touchpoint-fields-13.png)
...
![&quot;여름 홍보 종료&quot;를 위해 만든 캠페인이 있습니다](assets/touchpoint-fields-2.png)
...
* 나머지 4자리 숫자 세트에 대해 추출과 매핑을 반복합니다
   ...
   * 01을 추출하려면 값을 &quot;BZ=\d-**(\d**)**-\d**-\d&#x200B;**-\d**-\d**&quot;로 정의합니다.
   * 09를 추출하려면 값을 &quot;BZ=\d **-\d**-**(\d**)**-\d**-\d**&quot;로 정의합니다.
   * 03을 추출하려면 값을 &quot;BZ=\d **-\d**-\d&#x200B;**-**(\d&#x200B;**)**-\d**&quot;로 정의합니다.
   * 10을 추출하려면 값을 &quot;BZ=\d **-\d**-\d&#x200B;**-\d**-**(\d**)**&quot;로 정의합니다.

![10을 추출하려면 값을 &quot;BZ=\d](assets/touchpoint-fields-3.png)-\d&rbrack;(assets/touchpoint-fields-3.png)-\d&rbrack;(assets/touchpoint-fields-3.png)-\d&rbrack;(assets/touchpoint-fields-3.png)-(\d&rbrack;(assets/touchpoint-fields-3.png))&quot;&rbrack;(assets/touchpoint-fields-3.png)(으)로 정의합니다.
...
![Segmentc 및 Gradec의 Opportunity 개체에 별도의 필드가 있습니다.](assets/touchpoint-fields-4.png)
...
![터치포인트 필드를 사용하여 세그먼트를 만드는 기능을 사용할 수 있습니다.](assets/touchpoint-fields-5.png)
...
![설치 프로그램이 아래 스크린샷과 비슷합니다. 세그먼트 이름](assets/touchpoint-fields-6.png)
...
![실행 및 테스트할 수 있는 온라인 도구(https://regex101.com/(https://regex101.com/){target="blank"})가 있습니다.](assets/touchpoint-fields-8.png)

![실행 및 테스트할 수 있는 온라인 도구(https://regex101.com/(https://regex101.com/){target="blank"})가 있습니다.](assets/touchpoint-fields-9.png)
