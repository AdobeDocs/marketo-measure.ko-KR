...
>[!MORELIKETHIS]
>
>* [접점 제거 및 제외 개요](/help/channel-tracking-and-setup/touchpoint-removal-and-touchpoint-suppression.md)
>* [터치포인트를 삭제하지 않는 이유](/help/channel-tracking-and-setup/why-you-should-never-delete-touchpoints.md)
>* [구매자 접점(BT)과 구매자 속성 접점(BAT)](/help/configuration-and-setup/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md)
