---
description: Marketo Measure 사용자를 위한 Drift 통합 FAQ 지침
title: 드리프트 통합 FAQ
...
[!DNL Google Tag Manager]을(를) 사용하여 [!DNL Marketo Measure] 스크립트를 로드하는 사용자의 경우, 드리프트 채팅을 터치포인트 대상에서 제외하려면 `<span>` 스크립트 바로 뒤에 다음 [!DNL Marketo Measure]에 추가하십시오.
...
![Drift에 대한 터치포인트를 만드는 활동 규칙이 있는 경우](assets/chat-integration-1.png)
