---
description: Marketo Measure 사용자를 위한 A/B 테스트 설정 및 보고 지침
...
1. [!UICONTROL Buttons]에서 **[!UICONTROL New]** 선택을 취소합니다.
   ...
   ![1. Buttons에서 New.](assets/advanced-features-7.png)의 선택을 취소합니다.
...
![영업 기회가 있는 Marketo Measure A/BTests](assets/advanced-features-8.png)
...
![잠재 고객이 있는 Marketo Measure A/B 테스트](assets/advanced-features-9.png)

**[!DNL Marketo Measure]A/B 테스트(영업 기회 포함)**

![기회가 있는 Marketo Measure A/B 테스트](assets/advanced-features-10.png)
