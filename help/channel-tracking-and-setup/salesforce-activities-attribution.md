---
description: Marketo Measure 사용자를 위한 Salesforce 활동 속성 지침
...
![Marketo Measure Salesforce 활동 통합에서 특정 작업을 가져오고](assets/activities-attribution-10.png)
...
![각 영업 담당자에 대해 고유한 캠페인을 설정하려면](assets/activities-attribution-11.png)
...
![규칙이 필터 역할을 하여 레코드를 알려 줍니다](assets/activities-attribution-12.png)
...
![패키지 설치 시 Marketo Measure에 사용자 지정 Buyer Touchpoint이 포함됩니다](assets/activities-attribution-13.png)

작업 또는 이벤트에 대해 다른 규칙을 설정하는 것을 잊지 마십시오. 영업 팀이 활동을 기록하기 위해 사용하는 객체를 알고 있어야 합니다.

![작업 또는 이벤트에 대해 다른 규칙을 설정하는 것을 잊지 마십시오. 사용자](assets/activities-attribution-5.png)
...
![마지막으로 비용을 입력할 수도 있습니다](assets/activities-attribution-9.png)
