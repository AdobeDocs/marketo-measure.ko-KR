---
description: Marketo Measure 사용자를 위한 캠페인 및 캠페인 멤버 지침
title: 캠페인 및 캠페인 멤버
...
![Marketo Measure Salesforce 패키지에 레이블이 지정된 필드가 포함됩니다](assets/dynamics-lists-1.png)

선택 목록에서 사용할 수 있는 옵션은 다음과 같습니다.

![선택 목록에서 사용할 수 있는 옵션은 다음과 같습니다.](assets/dynamics-lists-10.png)
...
![Marketo Measure을 사용하기 전에 Marketing Automation 플랫폼을 사용한 경우](assets/dynamics-lists-2.png)
...
![목록이 일/주/개월 후에 업로드된 경우 필요합니다.](assets/dynamics-lists-4.png)
...
![터치포인트 일괄 업데이트 날짜가 설치된 Marketo에 포함되어 있습니다](assets/dynamics-lists-5.png)
...
![날짜 및 시간이 설정되면 선택한 업데이트를 클릭합니다](assets/dynamics-lists-6.png)

## 캠페인 비용 {#campaign-costs}

이 문서[에서 캠페인 비용 &#x200B;](/help/crm-campaign-costs.md){target="_blank"}에 대해 모두 알아보세요.
