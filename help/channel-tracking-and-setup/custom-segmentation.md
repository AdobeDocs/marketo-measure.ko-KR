...
이 기능을 사용하기 전에 필터링할 터치포인트 정보를 파악합니다. 레코드 종류에 대해 CRM의 정확한 값을 사용해야 합니다. 설정은 마케팅 funnel의 상단에서 하단으로 터치포인트를 필터링합니다.
...
![이 범례를 사용하여 이 페이지에 있는 다양한 아이콘을 이해합니다](assets/custom-segmentation-1.png)
...
![세그먼트 이름을 입력하십시오. 예를 들어 &#x200B;](assets/custom-segmentation-2.png)에 대해 하나의 세그먼트를 가질 수 있습니다.

* 더하기 아이콘을 클릭하여 규칙 입력 필드를 표시합니다. 필드 선택 목록의 옵션은 CRM에서 직접 필드를 가져옵니다

![더하기 아이콘을 클릭하여 규칙 입력 필드를 표시합니다. 옵션](assets/custom-segmentation-3.png)
