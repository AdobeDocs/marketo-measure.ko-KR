---
description: Marketo Measure 사용자를 위한 부메랑 단계 시나리오 지침
title: 부메랑 단계 시나리오
...
![리드 1이(가) 영업 기회가 있는 연락처로 전환됩니다.](assets/boomerang-stages-18.png)
...
![이 시나리오에서는 고객이 SQL만 추적하도록 선택했습니다](assets/boomerang-stages-19.png)
...
![이 시나리오에서는 고객이 MQL을 추적하고](assets/boomerang-stages-21.png)하도록 선택했습니다.
...
![잠재 고객 1의 모든 터치포인트가 영업 기회에 포함됩니다.](assets/boomerang-stages-22.png)
...
![이 시나리오에서는 고객이 MQL, SQL을 추적하도록 선택했습니다](assets/boomerang-stages-23.png)
...
![이 시나리오에서는 고객이 MQL, SQL을 추적하도록 선택했습니다](assets/boomerang-stages-25.png)
...
![이 시나리오에서는 고객이 데모를 추적하도록 선택했습니다.](assets/boomerang-stages-25.png)
