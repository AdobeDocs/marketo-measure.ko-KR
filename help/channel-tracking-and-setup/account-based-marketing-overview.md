...
[!DNL Salesforce] 인스턴스 내에서 ABM을 설정하는 방법에 대한 자세한 지침은 [Salesforce에서 ABM 페이지 레이아웃 설정](/help/channel-tracking-and-setup/account-based-marketing-overview.md){target="_blank"}으로 이동하십시오.
...
1. [!UICONTROL Fields]&#x200B;(으)로 이동하여 &quot;예측 참여 점수&quot; 필드를 계정 정보 섹션으로 이동하십시오.
   ...
   ![1. 필드로 이동하여 필드 &quot;Predictive Engagement Score&quot;](assets/account-marketing-3.png)를 이동합니다.
