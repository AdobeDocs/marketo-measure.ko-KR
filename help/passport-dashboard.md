---
description: 잠재 고객 연락처 및 기회가 시간에 따라 단계를 이동하는 방법을 추적하는 Passport 대시보드에 대해 설명합니다.
title: Passport 대시보드
feature: Reporting
...
* 지정된 기간 동안 각 임시 단계를 통해 진행된 개별 리드 또는 연락처의 수는 몇 개입니까?
   * _예_: 리드 A가 2023년 1월 1일에 단계 1에 있다가 2023년 3월 31일까지 단계 5로 발전하면 2023년 1분기 여권 분석은 단계 1부터 5까지 리드 A를 계산합니다.
...
![시작 날짜와 종료 날짜가 모두 포함됩니다.](assets/passport-dashboard-1.png)
...
![시작 날짜와 종료 날짜가 모두 포함됩니다.](assets/passport-dashboard-2.png)
