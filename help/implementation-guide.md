...
[Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}에 대해 자세히 알아보세요.
...
[데이터 세트 개요](https://experienceleague.adobe.com/ko/docs/experience-platform/catalog/datasets/overview#){target="_blank"}: AEP에 성공적으로 수집된 모든 데이터는 데이터 세트로 Data Lake 내에 보관됩니다. 데이터 세트는 스키마(열) 및 필드(행)를 포함하는 데이터 수집을 위한 저장소 및 관리 구조입니다.
...
![원본에서 데이터 사용 템플릿 추가를 선택합니다](assets/marketo-guide-2.png)

* 계정 및 모든 B2B 템플릿을 선택하여 10개의 표준 B2B 스키마를 만듭니다.

![표준 B2B를 만들 계정 및 모든 B2B 템플릿을 선택하십시오](assets/marketo-guide-3.png)
...
1. Source의 필드를 스키마에 매핑합니다.
   ...
   >[!NOTE]
   >
   >[Marketo Measure Ultimate 데이터 무결성 요구 사항](/help/data-integrity-requirement.md){target="_blank"}
...
![옵션 1: UI에서 직접 쿼리를 실행하려면 쿼리에 액세스하세요](assets/marketo-guide-4.png)
...
![사용자가 다른 원본의 단계를 매핑할 수 있습니다.](assets/marketo-guide-5.png)
