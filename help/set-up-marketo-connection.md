---
description: Marketo Measure 사용자를 위한 Marketo 연결 지침 설정
title: Marketo 연결 설정
...
>[!PREREQUISITES]
>
>[/Marketo Engage 연결에 대해 &#x200B;](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/users-and-roles/create-an-api-only-user.html?lang=ko)API 전용 사용자 역할을 만듭니다[!DNL Marketo Measure].
...
1. [!UICONTROL Integrations]에서 **[!UICONTROL Connections]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 통합에서 연결을 클릭합니다.](assets/set-connection-8.png)

1. **[!UICONTROL Set Up New CRM Connection]**&#x200B;를 클릭합니다.

   ![1. 새 CRM 연결 설정을 클릭합니다.](assets/set-connection-9.png)

1. Marketo 옆에 있는 **[!UICONTROL Connect]** 단추를 클릭합니다.

   ![1. Marketo 옆에 있는 연결 단추를 클릭합니다.](assets/set-connection-5.png)

1. 새 탭에서 Marketo Engage 계정에 로그인합니다. **관리자** > **웹 서비스**(으)로 이동합니다. REST API로 스크롤합니다. 끝점 및 ID 서비스 URL을 강조 표시하고 저장합니다. 다음 단계에서 필요합니다.

   ![1. 새 탭에서 Marketo Engage 계정에 로그인합니다.](assets/set-connection-6.png)
...
1. 클라이언트 ID 및 클라이언트 암호를 강조 표시하고 저장합니다. Click **Close**.
   ...
   ![1. 클라이언트 ID 및 클라이언트 암호를 강조 표시하고 저장합니다. 닫기를 클릭합니다.](assets/set-connection-3.png)

1. [!DNL Marketo Measure]&#x200B;(으)로 돌아가서 수집한 데이터로 필드를 채웁니다.

   ![1. Marketo Measure으로 돌아가서 데이터로 필드 채우기](assets/set-connection-1.png)

1. 값을 입력한 후 **[!UICONTROL Authenticate]**&#x200B;을(를) 클릭합니다. Marketo Engage 계정이 [!DNL Marketo Measure]에 연결되어 있습니다.

   ![1. 값을 입력한 후 [인증]을 클릭합니다. Marketo Engage](assets/set-connection-2.png)
