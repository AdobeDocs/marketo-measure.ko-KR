...
>[!PREREQUISITES]
>
>[/Marketo Engage 연결에 대해 &#x200B;](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/users-and-roles/create-an-api-only-user.html)API 전용 사용자 역할을 만듭니다[!DNL Marketo Measure].
