...
[!DNL Marketo Measure]&#x200B;(이전 Bizible)은 마케터에게 매출을 증대시키고 투자 수익을 극대화하는 데 가장 효과적인 마케팅 활동을 insight에 제공합니다. [!DNL Marketo Measure] 는 채널 성과를 자동으로 추적 및 보고하여 가장 고객 참여를 유도하는 채널에 대한 가시성을 제공하고 그에 따라 마케팅 지출을 최적화할 수 있는 마케팅 속성 솔루션입니다.
...
![Marketo Measure 계층 1-3](assets/marketo-overview-1.png)
...
![마케터가 B2B 데이터를 가져와야 합니다(예: Account, Opportunity,](assets/marketo-overview-2.png)).
...
![지정된 데이터의 지정된 엔터티(예: 계정)에 대한 데이터](assets/marketo-overview-6.png)
...
![캠페인 멤버 접점 규칙 및 활동 접점 규칙은 데이터 세트별로 다릅니다.](assets/marketo-overview-5.png)

![캠페인 멤버 접점 규칙 및 활동 접점 규칙은 데이터 세트별로 다릅니다.](assets/marketo-overview-8.png)
