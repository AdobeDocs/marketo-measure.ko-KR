...
![Say Kate가 Adwords 광고를 통해 처음으로 www.adobe.com을 방문한다고 함](assets/overview-resources-9.png)
...
![Adwords 광고를 통한 Kate의 첫 www.adobe.com 방문은 50%](assets/overview-resources-11.png)
...
![Hillary가 가격 책정 페이지에 대한 링크가 포함된 이메일을 받고](assets/overview-resources-12.png)
...
![기회 생성 후 Kate, Austin 및 Hillary는 Marketo을 홍보하기로 결정했습니다](assets/overview-resources-13.png)
