...
![사용자 지정 SSO 로그인 유형 옵션이 있는 인증 설정 페이지](assets/single-sign-on-1.png)
...
![사용자 특성 매핑 필드가 있는 SAML 구성 양식](assets/single-sign-on-2.png)
...
![표준 사용자 및 관리 옵션을 사용한 사용자 역할 매핑 구성](assets/single-sign-on-3.png)
...
![SAML 인증 테스트 단추 및 유효성 검사 상태 메시지](assets/single-sign-on-4.png)
...
![인증 설정 및 확인 메시지에 대한 저장 단추](assets/single-sign-on-5.png)
...
![SSO 로그인 성공 확인 화면](assets/single-sign-on-6.png)
...
![사용자 관리 아래의 역할을 표시하는 Salesforce 설정 메뉴](assets/6.png)
...
보안 역할로 ![Dynamics 설정 메뉴 탐색](assets/7.png)

![사용 가능한 역할 옵션을 표시하는 Dynamics 보안 역할 목록](assets/8.png)
...
![외부 Google 로그인 사용자를 표시하는 사용자 페이지](assets/9.png)
