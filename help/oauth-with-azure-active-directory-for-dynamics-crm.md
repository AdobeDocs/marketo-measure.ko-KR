...
1. 왼쪽 메뉴에서 **[!UICONTROL App Registrations]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 왼쪽 메뉴에서 앱 등록을 클릭합니다.](assets/microsoft-guide-2.png)

1. 맨 위에 있는 **[!UICONTROL New Registration]**&#x200B;을(를) 클릭합니다.

   ![1. 맨 위에 있는 새 등록을 클릭합니다.](assets/microsoft-guide-3.png)
...
1. 왼쪽 메뉴에서 **[!UICONTROL Authentication]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 왼쪽 메뉴에서 [인증]을 클릭합니다.](assets/microsoft-guide-4.png)
...
1. 권한 탭에서 **[!UICONTROL Grant Admin Consent for (instance name)]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 권한 탭에서 (인스턴스](assets/microsoft-guide-8.png))에 대한 관리자 동의 부여를 클릭합니다

1. **[!UICONTROL Accept]**&#x200B;를 클릭합니다.

   ![1. [수락]을 클릭합니다.](assets/microsoft-guide-9.png)
...
1. Dynamics 연결을 처음 설정할 때 [이 문서](/help/microsoft-dynamics-crm-installation-guide.md)에서 &quot;데이터 공급자로서 CRM&quot; 섹션의 1-5단계를 따르십시오.
...
![b. 클라이언트 암호는 Azure 포털에서 만든 응용 프로그램 암호입니다.](assets/microsoft-guide-11.png)
