...
1. 연결의 CRM 섹션 아래에서 **[!UICONTROL Set Up New CRM Connection]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 연결의 CRM 섹션 아래에서 새로 설정](assets/bizible-taxonomy-1.png)을 클릭합니다.
...
Marketo Measure은 CRM 통합 작업을 사용하여 통합 사용자를 통해 클라이언트의 Salesforce과 상호 작용합니다. 이 사용자를 통한 모든 데이터 교환은 Salesforce API 크레딧을 사용합니다. 통합 사용자에게 크레딧 할당량을 할당할 수 있는 기능이 있으며, 이는 과도한 API 호출을 규제하는 역할을 합니다. 이 할당량 또는 제한은 24시간마다 재설정됩니다.

**내 계정** > **설정** > **CRM** > **일반** > **일별 CRM API 제한**&#x200B;을 통해 Marketo Measure에서 이 제한에 액세스하고 테넌트에 대해 이 제한을 구성할 수 있습니다.

![내 계정 설정을 통해 Marketo Measure에서 이 제한에 액세스할 수 있습니다](assets/connect-salesforce-2.png)
...
1. 편집하려면 잠금 아이콘을 클릭하십시오.
   ...
   ![1. 편집하려면 잠금 아이콘을 클릭하십시오.](assets/connect-salesforce-3.png)
