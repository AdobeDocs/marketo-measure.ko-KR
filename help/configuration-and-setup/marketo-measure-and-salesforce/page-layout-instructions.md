...
1. **[!UICONTROL Page Layouts]**&#x200B;를 클릭합니다.
   ...
   ![캠페인 아래의 페이지 레이아웃 옵션을 표시하는 Salesforce 설정](assets/1-1.jpg)

1. 업데이트할 페이지 레이아웃 옆에 있는 **[!UICONTROL Edit]**&#x200B;을(를) 클릭합니다.

   ![레이아웃 이름 옆에 [편집] 단추가 있는 캠페인 페이지 레이아웃 목록](assets/2-1.jpg)
...
1. [!UICONTROL fields] 옵션에서 **[!UICONTROL Enable Buyer Touchpoints]** 필드를 선택하고 페이지에서 원하는 위치로 드래그합니다. 그런 다음 **[!UICONTROL Touchpoint Start Date]** 및 **[!UICONTROL Touchpoint End Date]** 필드를 추가합니다.
   ...
   ![터치포인트 시작 및 종료 날짜 필드가 있는 구매자 터치포인트 필드 사용을 보여 주는 페이지 레이아웃 편집기](assets/3-2.png)

1. 그런 다음 페이지 맨 위에서 빠른 찾기 메뉴의 &quot;[!UICONTROL Buttons]&quot; 옵션을 클릭합니다.

1. **[!UICONTROL Bulk Update Touchpoint Date]** 단추를 사용자 지정 단추 섹션으로 끕니다.

   ![사용자 지정 단추 섹션에 터치포인트 날짜 대량 업데이트 단추가 있는 페이지 레이아웃 편집기](assets/4-1.jpg)

1. **[!UICONTROL Save]**&#x200B;를 클릭합니다.

   >[!NOTE]
   >여러 캠페인 레코드 유형을 사용하는 경우 **[!UICONTROL Enable Buyer Touchpoints]** 필드에 대한 선택 목록 값을 업데이트해야 합니다. 자세한 내용은 [이 문서](/help/channel-tracking-and-setup/offline-channels/configurations-record-types.md)를 참조하세요.
...
1. **[!UICONTROL Marketo Measure Lead Related List]** VisualForce 페이지를 페이지 레이아웃 섹션으로 끌어옵니다.
   ...
   ![Marketo Measure 리드 관련 목록 VisualForce 페이지가 있는 리드 페이지 레이아웃 편집기](assets/5-1.png)
...
[!DNL Marketo Measure] ABM 기능을 사용하는 경우 [추가 페이지 레이아웃 지침을 보려면 여기를 클릭](/help/advanced-features/account-based-marketing/account-based-marketing-overview.md)하십시오.
...
1. 정렬 기준: 터치포인트 날짜, 오름차순
   ...
   열 및 정렬 순서 설정이 있는 ![구매자 접점 관련 목록 구성](assets/6.jpg)

1. 단추 옵션을 확장하고 **[!UICONTROL New]**&#x200B;을(를) 선택 취소합니다.

   ![단추 섹션에서 선택 취소된 새 단추를 표시하는 관련 목록 속성](assets/7.png)
...
[!DNL Marketo Measure] ABM 기능을 사용하는 경우 [추가 페이지 레이아웃 지침](/help/advanced-features/account-based-marketing/account-based-marketing-overview.md)을 검토하십시오.
