---
description: Marketo Measure 사용자를 위한 오류 알림 지침
title: 오류 알림
...
![Marketo Measure에서 전체 알림 메시지를 보려면 [보기]를 클릭하세요](assets/adobe-setup-1.png)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>API 크레딧 할당을 조정하는 데 도움이 필요하면 CRM에 대한 다음 설명서를 참조하십시오.</p>
          ...
          <ul>
            <li><b>설정</b> &gt; <b>CRM</b> &gt; <b>일반</b>(으)로 이동</li>
          ...
          <p>
          &lt;img alt="오류 알림 3" src="assets/error-notifications-3.png"
          </p>
      </td>
    </tr>
    <tr>
...
흐름 트리거 <a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">에 대한 Salesforce 설명서는 여기에서 찾을 수 있습니다</a>.
    ...
    <tr>
      ...
      <td>삽입/업데이트 실패의 원인이 되는 트리거 코드를 검토합니다. 트리거에 대한 자세한 내용은 다음 Salesforce 설명서를 참조하십시오.
        ...
        <p>
        <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Marketo Measure 사용자</a>에게 필요한 모든 권한을 제공하십시오.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li><a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">사용자 지정 유효성 검사 규칙</a>에서 Marketo Measure 전용 사용자를 제외하십시오.
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>Marketo Measure에 필요한 권한에 대한 지침은 다음 <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Experience League 문서</a>를 참조하십시오.</td>
    </tr>
    <tr>
      ...
      <td>올바른 구성을 위해 다음 도움말 문서를 참조하십시오.
        <ul>
          <li>
            <a href="/help/adobe-analytics.md">Adobe Analytics과 Marketo Measure 통합</a>
          </li>
          <li>
            <a href="https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html?lang=ko">고객 속성 소스를 만들고 데이터 파일 업로드</a>
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>접두사가 "bizible2__"인 모든 필드에 대한 읽기 및 쓰기 권한이 필요합니다. 이러한 필드의 전체 목록은 이 문서에서 <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">찾을 수 있습니다</a>.</td>
    </tr>
    <tr>
      ...
      <td>CRM에서 이 권한을 활성화하는 데 도움이 필요하면 다음 Experience League 문서를 참조하십시오<br/>
          <a href="/help/marketo-measure-salesforce-reporting/enabling-the-permission-to-edit-converted-leads.md">전환된 잠재 고객을 편집할 수 있는 권한을 사용하도록 설정</a></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>이 오류에는 Salesforce 조직에만 해당되는 몇 가지 이유가 있습니다. 다음은 이 문제를 해결할 수 있는 몇 가지 일반적인 문제 해결 단계입니다.
        <ul>
          <li>각 <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">개체 및 필드</a>에 필요한 모든 권한을 검토하십시오.</li>
          <li><a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">사용자 지정 유효성 검사 규칙</a>에서 Marketo Measure 전용 사용자를 제외하십시오.</li>
          <li>Marketo Measure "<a href="https://developer.salesforce.com/docs/atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_view_all_mod_all.htm">모두 수정</a>" 권한을 부여합니다.</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <p>
      '모든 데이터 보기' 권한 <a href="https://developer.salesforce.com/docs/atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_view_all_mod_all.htm">에 대한 자세한 정보는 여기</a>에서 확인할 수 있습니다.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Salesforce 조직에서 선택 목록 제한 설정을 비활성화합니다.
          <p>
          <a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">사용자 지정 유효성 검사 규칙</a>에서 Marketo Measure 전용 사용자를 제외하십시오.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>패키지를 최신 버전으로 업그레이드하십시오.
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">모범 사례</a>
          </li>
