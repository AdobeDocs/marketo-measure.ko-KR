...
>[!MORELIKETHIS]
>
>* [온라인 터치포인트를  [!DNL Marketo Measure] 채널/하위 채널에 매핑](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
>* [SFDC 내에서 CRM 캠페인 동기화](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
>* [CRM 캠페인을  [!DNL Marketo Measure]](/help/channel-tracking-and-setup/custom-campaign-sync.md) 내에서 동기화 중
>* [CRM 캠페인을  [!DNL Marketo Measure] 채널/하위 채널에 매핑](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
>* [판매 활동에서 접점 만들기](/help/channel-tracking-and-setup/salesforce-activities-attribution.md)
>* [채널/하위 채널에 대한 활동 FAQ 및 활동 터치포인트 매핑](/help/channel-tracking-and-setup/activities-attribution-faq.md)
