---
description: Adobe Admin Console 설정
...
![Marketo Measure 제품 카드를 표시하는 Adobe Admin Console](assets/adobe-admin-console-setup-1.png)
...
![Marketo Measure 인스턴스에 대한 Adobe Admin Console 제품 프로필 목록](assets/adobe-admin-console-setup-2.png)
...
>[!NOTE]
>[!DNL Marketo Measure] 관리자([experience.adobe.com/marketo-measure](https://experience.adobe.com/marketo-measure){target="_blank"}에서)가 되려면 사용자가 _제품 카드 내의_ 제품 프로필에 사용자 [!DNL Marketo Measure] 및[!DNL Marketo Measure] 관리자로 추가되어 있어야 합니다.

**에[!DNL Marketo Measure]**&#x200B;로그인 중

사용자가 제품 프로필에 추가되면 [!DNL Marketo Measure]experience.adobe.com/marketo-measure **에서** Adobe ID으로 로그인[&#x200B; 옵션을 선택하여 &#x200B;](https://experience.adobe.com/marketo-measure){target="_blank"} 인스턴스에 액세스할 수 있습니다.

![Adobe ID으로 로그인 옵션이 있는 Marketo Measure 로그인 화면](assets/adobe-admin-console-setup-3.png)
