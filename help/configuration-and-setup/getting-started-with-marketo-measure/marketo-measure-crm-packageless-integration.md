...
[!DNL Marketo Measure]과(와) 패키지 없는 통합은 CRM에서 사용자 지정 개체/엔터티 또는 사용자 지정 필드를 만들지 않으려는 고객을 위한 것입니다. 외부 Data Warehouse을 사용하는 고객에게도 적합한 옵션입니다.
...
[!DNL Salesforce]명의 고객이 [여기](/help/configuration-and-setup/marketo-measure-and-salesforce/install-set-up.md)를 클릭합니다.

[!DNL Microsoft Dynamics]명의 고객이 [여기](/help/marketo-measure-and-dynamics/microsoft-dynamics-crm-installation-guide.md)를 클릭합니다.
