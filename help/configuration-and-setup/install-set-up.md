...
설치를 완료한 후 원하는 경우 [!DNL Marketo Measure] 필드로 [[!DNL Salesforce] 페이지 레이아웃](/help/configuration-and-setup/page-layout-instructions.md){target="_blank"}을 업데이트할 수 있습니다.
