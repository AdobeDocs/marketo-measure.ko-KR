---
description: Adobe Admin Console 프로필을 통한 Marketo Measure 액세스 설정 및 로그인 안내서
...
![Adobe Admin Console에 액세스하면 Marketo Measure이 표시됩니다](assets/adobe-setup-1.png)
...
![Marketo Measure 제품 카드를 클릭하면 사용자의 모든 정보가 표시됩니다](assets/adobe-setup-2.png)
...
![사용자가 제품 프로필에 추가되면 가능합니다](assets/adobe-setup-3.png)
