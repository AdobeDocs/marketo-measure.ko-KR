...
[!DNL Salesforce]명의 고객이 [여기](/help/configuration-and-setup/install-set-up.md)를 클릭합니다.

[!DNL Microsoft Dynamics]명의 고객이 [여기](/help/microsoft-dynamics-crm-installation-guide.md)를 클릭합니다.
