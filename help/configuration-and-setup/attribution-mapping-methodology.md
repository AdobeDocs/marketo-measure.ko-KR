...
![대부분의 클라이언트가 계정 ID 매핑을 사용하는 동안 Marketo Measure은 다음을 볼 수 있습니다](assets/adobe-setup-2.png)
...
![단순히 영업 기회에 대한 연락처 역할을 살펴보는 것 이상의 기능, Marketo](assets/adobe-setup-3.png)
