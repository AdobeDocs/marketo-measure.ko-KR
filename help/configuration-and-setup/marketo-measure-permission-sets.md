...
[!DNL Marketo Measure] Salesforce 패키지에는 세 개의 권한 집합이 포함되어 있습니다. 이 권한 집합은 관리자, 마케터 및 표준 사용자의 [!DNL Marketo Measure]에 대한 액세스 권한을 제공합니다.
...
1. 사용 권한 집합의 사용자를 선택하고 **[!UICONTROL Assign]**&#x200B;을(를) 클릭합니다.
   ...
   ![1. 사용 권한 집합의 사용자를 선택하고 [할당]을 클릭하십시오.](assets/bizible-full-1.png)
