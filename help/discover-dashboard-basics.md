...
| 이름 | 설명 |
| --- | --- |
| 필터 전환 단추 | 필터 창을 열거나 닫으려면 전환합니다. |||||||||||||||||||||||||![ — | — |] (apng) |
| 검색창 | 필터 창 상단의 검색을 사용하여 특정 필터를 검색합니다. 각 필터에는 자체 검색 창도 있습니다. ||||||||||||||||||||||||||![ — | — |] (apng) |
| 필터 지우기 단추 | 필터를 지우려면 각 필터의 오른쪽 상단 모서리에 있는 지우개 아이콘을 클릭합니다. ||||||||||||||||||||||||||![ — | — |] (apng) |
| 적용 단추 | 을(를) 클릭하여 대시보드에서 필터 변경 사항을 확인하고 구현합니다. |||||||||||||||||||||![ — | — |] (apng) |
