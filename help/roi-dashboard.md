---
description: 시간에 따른 채널 하위 채널 및 캠페인의 비용 매출과 ROI를 비교하기 위한 ROI 대시보드를 살펴봅니다
title: ROI 대시보드
feature: Reporting
...
* **비용**: 연결된 데이터 원본의 총 비용과 수동으로 업로드한 비용입니다.
...
* **총 새 잠재 고객 수**: 터치된 잠재 고객과 터치되지 않은 잠재 고객을 포함하여 생성된 총 새 잠재 고객 수입니다.
* **새 잠재 고객당 비용**: 총 비용을 새 잠재 고객의 총 수로 나눈 새 잠재 고객당 평균 비용입니다.
* **새 기회 합계**: 터치된 기회와 터치되지 않은 기회를 모두 포함하여 생성된 새 기회의 총 수입니다.
...
![실현된 ROI: 실현된 속성 수익을 필터링된 날짜의 비용으로 나눈 값](assets/roi-dashboard-9.png)
...
![비정상적으로 높거나 낮은 이상치 채널 또는 하위 채널이 있습니까](assets/roi-dashboard-8.png)
...
![실현된 ROI 추세가 중요한 마케팅과 어떤 관련이 있습니까](assets/roi-dashboard-7.png)
...
![시간이 지남에 따라 특정 채널에 대한 비용이 어떻게 진화했습니까?](assets/roi-dashboard-6.png)
...
![다른 마케팅 채널, 하위 채널 또는 캠페인에 비해 자금이 부족한 것 같은 마케팅 경로는 무엇입니까?](assets/roi-dashboard-5.png)
