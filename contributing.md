...
이 프로젝트는 Adobe [수행 코드](code-of-conduct.md)를 준수합니다. 참여 시 이 행동 강령을 따르는 것으로 간주됩니다. 부적절한 행동 보고 대상
...
본 프로젝트에 대한 당사 외부의 모든 참여에는 서명한 CLA(참여자 라이선스 계약)가 있어야 합니다. 이 계약은 Adobe에 참여자의 참여 내용을 프로젝트의 일부로 재배포할 권한을 부여합니다. [CLA에 서명](https://opensource.adobe.com/cla.html)해 주세요. Adobe CLA는 
